export default [

  {
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Nausica%C3%A4-del-valle-del-viento.jpg",
    facts: {
      "Duración": "1h 57m",
      "Estreno": "1984",
      "Géneros": "Fantasía, Ciencia Ficción",
      "Recaudación": "$10 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/El-castillo-en-el-cielo.jpg",
    facts: {
      "Duración": "2h 4m",
      "Estreno": "1986",
      "Géneros": "Aventura, Fantasía",
      "Recaudación": "$15 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/La-tumba-de-las-luciernagas.jpg",
    facts: {
      "Duración": "2h 4m",
      "Estreno": "1988",
      "Géneros": "Drama, Bélico, Terror",
      "Recaudación": "$14 millones USD en taquilla"
    }
  },
{
    id: "mi-vecino-totoro",
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Mi-vecino-totoro.png",
    facts: {
      "Duración": "1h 26m",
      "Estreno": "1988",
      "Géneros": "Familia, Fantasía, Aventura",
      "Recaudación": "$30 millones USD en taquilla"
    }
  },
{
  ...
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Recuerdos-del-ayer.webp",
    facts: {
      "Duración": "1h 58m",
      "Estreno": "1991",
      "Géneros": "Drama, Romance",
      "Recaudación": "$525 mil USD en taquilla"
    }
  },
{
    id: "porco-rosso",
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Porco-rosso.jpg",
    facts: {
      "Duración": "1h 42m",
      "Estreno": "1992",
      "Géneros": "Aventura, Fantasía",
      "Recaudación": "$34 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Puedo-escuchar-el-mar.jpg",
    facts: {
      "Duración": "1h 12m",
      "Estreno": "1993",
      "Géneros": "Romance, Drama",
      "Recaudación": "$22 millones USD en taquilla"
    }
  },
{
    id: "pompoko",
    ...
    imageUrl: "Ihttps://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Pompoko.webp",
    facts: {
      "Duración": "1h 58m",
      "Estreno": "1994",
      "Géneros": "Comedia, Fantasía, Aventura",
      "Recaudación": "$42 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Susurros-del-coraz%C3%B3n.webp",
    facts: {
      "Duración": "1h 46m",
      "Estreno": "1995",
  ...
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/La-princesa-Mononoke.webp",
    facts: {
      "Duración": "2h 13m",
      "Estreno": "1997",
      "Géneros": "Fantasía, Aventura",
      "Recaudación": "$159 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Mis-vecinos-los-Yamada.jpg",
    facts: {
      "Duración": "1h 44m",
      "Estreno": "1999",
      "Géneros": "Comedia, Infantil",
      "Recaudación": "$20 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/El-viaje-de-Chihiro.png",
    facts: {
      "Duración": "2h 3m",
      "Estreno": "2001",
      "Géneros": "Fantasía, Aventura",
  ...
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/haru-en-el-reino-de-los-gatos.jpg",
    facts: {
      "Duración": "1h 15m",
      "Estreno": "2002",
      "Géneros": "Fantasía, Aventura",
      "Recaudación": "$54 millones USD en taquilla"
    }
  },
{
id: "el-castillo-ambulante",
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/El-castillo-ambulante.jpg",
    facts: {
      "Duración": "1h 59m",
      "Estrenos": "2004",
      "Género": "Fantasía, Romance, Bélico",
      "Recaudación": "$235 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Cuentos-de-Terramar.jpg",
    facts: {
      "Duración": "1h 55m",
      "Estreno": "2006",
      "Géneros": "Fantasía, Aventura",
      "Recaudación": "$68 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Ponyo.jpg",
    facts: {
      "Duración": "1h 40m",
      "Estreno": "2008",
      "Géneros": "Aventura, Fantasía",
      "Recaudación": "$201 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Arrietty-y-el-mundo-de-los-diminutos.jpg",
    facts: {
      "Duración": "1h 34m",
      "Estreno": "2010",
      "Géneros": "Fantasía, Aventura",
      "Recaudación": "$145 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/La-Colina-de-las-Amapolas.jpg",
    facts: {
      "Duración": "1h 31m",
      "Estreno": "2011",
      "Géneros": "Drama, Romance",
  ...
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/El-cuento-de-la-princesa-Kaguya.jpg",
    facts: {
      "Duración": "2h 17m",
      "Estreno": "2013",
      "Géneros": "Drama, Fantasía",
      "Recaudación": "$24 millones USD en taquilla"
    }
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/El-recuerdo-de-Marnie.jpg",
    facts: {
      "Duración": "1h 43m",
      "Estreno": "2014",
  ...
  },
{
    ...
    imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/Earwig-y-la-bruja.webp",
    facts: {
      "Duración": "1h 22m",
      "Estreno": "2020",
      "Géneros": "Aventura, Fantasía",
      "Recaudación": "842 mil USD en taquilla"
    }
  },
{
  ...
  imageUrl: "https://raw.githubusercontent.com/Addis-cx/DEV013-dataverse/main/src/Imagenes/El-chico-y-la-garza.jpg",
  facts: {
    "Duración": "2h 4m",
    "Estreno": "2023",
    "Géneros": "Drama, Acción, Fantasía",
    "Recaudación": "$155 millones USD en taquilla"
  }
 }
];